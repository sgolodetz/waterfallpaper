...
\caption[Case analysis for step 2(a) of the SG method]{Case analysis for step 2(a) of the SG method (the circled node is the one currently under consideration in each case)}
...
\caption[Case analysis for step 2(b) of the SG method]{Case analysis for step 2(b) of the SG method (a blue edge indicates that the edge would be contracted; a red edge indicates that it wouldn't). The labels are AI = ambiguously in, AO = ambiguously out, NF = no flow, UI = unambiguously in and UO = unambiguously out.}
