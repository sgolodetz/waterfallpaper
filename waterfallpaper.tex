...
%---
\begin{stusubfig}{!t}
	\subfigure[The initial tree]{\includegraphics[height=9cm]{segmentation-waterfall-smg-example-initial.png}}%
	\hspace{4mm}%
	\subfigure[After step $1$]{\includegraphics[height=9cm]{segmentation-waterfall-smg-example-pass1.png}}%
	\hspace{4mm}%
	\subfigure[After step $2$]{\includegraphics[height=9cm]{segmentation-waterfall-smg-example-pass2.png}}%
