...
\caption{Finding and contracting a graph's local minima for Marcotegui's method: (a) the graph from \cite{marcotegui05} and its local minima (drawn in red/dashed); (b) contracting/colouring the local minima (the edges to be contracted are drawn in blue).}
