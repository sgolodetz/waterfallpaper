...
\caption{Finding and contracting a graph's local minima for Marcotegui's method: (a) the graph from \cite{marcotegui05} and its local minima (drawn in red/dashed); (b) contracting the local minima (the edges to be contracted are drawn in blue/dotted).}
...
%---
\begin{stusubfig}{p}
	\subfigure[Level 7]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-a.png}}%
	\hspace{4mm}%
	\subfigure[Level 6]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-b.png}}%
	\hspace{4mm}%
	\subfigure[Level 5]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-c.png}}%
	\hspace{4mm}%
	\subfigure[Level 4]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-d.png}}%
	\\
	\subfigure[Level 3]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-e.png}}%
	\hspace{4mm}%
	\subfigure[Level 2]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-f.png}}%
	\hspace{4mm}%
	\subfigure[Level 1]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-g.png}}%
	\hspace{4mm}%
	\subfigure[Result]{\includegraphics[width=.19\linewidth]{segmentation-waterfall-nicholls-example-h.png}}%
...
\begin{stusubfig}{p}
	...
	\hspace{4mm}
	\subfigure[UI/AO]{\includegraphics[height=5cm]{segmentation-waterfall-smg-mergecases-uiao.png}}%
	\hspace{4mm}
...
%---
\begin{stusubfig}{!t}
	\subfigure[The initial tree]{\includegraphics[height=8.8cm]{segmentation-waterfall-smg-example-initial.png}}%
	\hspace{4mm}%
	\subfigure[After step $1$]{\includegraphics[height=8.8cm]{segmentation-waterfall-smg-example-pass1.png}}%
	\hspace{4mm}%
	\subfigure[After step $2$]{\includegraphics[height=8.8cm]{segmentation-waterfall-smg-example-pass2.png}}%
